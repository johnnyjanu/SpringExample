package com.maeun.spring.ex.mybatis;
...
import com.maeun.spring.ex.mybatis.domain.Review;
import com.maeun.spring.ex.mybatis.service.ReviewService;
...
public class ReviewController {
	...
	public Review review(@RequestParam("id") int id) {
		...
		Review review = reviewService.getReview(5);
		return review;
	}
